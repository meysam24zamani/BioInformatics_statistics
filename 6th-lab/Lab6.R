...
#6. (2p) Perform the Armitage trend test for association between disease and number of M alleles. Report the
#test statistic and reference distribution and the p-value of the test. Do you find evidence for association?
...
#7. (4p) Test for association between genotype and disease status by a logistic regression of disease status on
#genotype, treating the latter as categorical. Do you find significant evidence for association? Which allele
#increase the risk for the disease? Give the odds ratios of the genotypes with respect to base line genotype
#mm. Provide 95% confidence intervals for these odds ratios.

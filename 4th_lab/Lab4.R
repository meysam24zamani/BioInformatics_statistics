#1. Apolipoprotein E (APOE) is a protein involved in Alzheimer's disease. 
#The corresponding gene APOE has been mapped to chromosome 19. The file APOE.dat contains genotype information
#of unrelated individuals for a set of SNPs in this gene. Load this data into the R environment. 
#APOE.zip contains the corresponding .bim, .fam and .bed files.
#You can use the .bim file to obtain information about the alleles of each polymorphism.
...
#4. Estimate haplotype frequencies using the haplo.stats package (set the minimum posterior probability to 0.001). 
#How many haplotypes do you and? List the estimated probabilities in decreasing order. Which haplotype number is the most common?
...
#5. Is the haplotypic constitution of any of the individuals in the database ambiguous or uncertain?
#For how many? What is the most likely haplotypic constitution of individual NA20763? 
#(identify the constitution by the corresponding haplotype numbers).
...
#6. Suppose we would delete polymorphism rs374311741 from the database prior to haplotype estimation.
#Would this affect the results obtained? Justify your answer.

unique(Y[,'rs374311741'])


#7. Remove all genetic variants that have a minor allele frequency below 0.10 from the database, and re-run haplo.em.
#How does this affect the number of haplotypes?
...
#8. We could consider the newly created haplotypes in our last run of haplo.em as the alleles of a new superlocus.
#Which is, under the assumption of Hardy-Weinberg equilibrium, the most likely genotype at this new locus? 
#What is the probability of this genotype? Which genotype is the second most likely, and what is its probability?
